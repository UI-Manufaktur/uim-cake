...
class I18n
{
     ...
     * ```
     *
     * @param string myName The domain of the translation messages.
     ...
     * @return void
     */
    static auto setTranslator(string myName, callable $loader, Nullable!string $locale = null): void
    {
        $locale = $locale ?: static::getLocale();

        $translators = static::translators();
        $loader = $translators.setLoaderFallback(myName, $loader);
        $packages = $translators.getPackages();
        $packages.set(myName, $locale, $loader);
    }
     ...
     */
    static auto getTranslator(string myName = 'default', Nullable!string $locale = null): Translator
    {
        $translators = static::translators();
        ...
        $translator = $translators.get(myName);
        if ($translator === null) {
     ...
     *
     * ```
     *  import uim.baklava.I18n\MessagesFileLoader;
     ...
     *      $package.setMessages(myMessage);
     *      $package.setFallback('default');
     *      return $package;
     *  });
     * ```
     *
     * @param string myName The name of the translator to create a loader for
     * @param callable $loader A callable object that should return a Package
     * instance to be used for assembling a new translator.
     * @return void
     */
    static function config(string myName, callable $loader): void
    {
        static::translators().registerLoader(myName, $loader);
    }
     ...
     * @return void
     */
    static auto setLocale(string $locale): void
    {
     ...
     * @return string
     */
    static auto getDefaultLocale(): string
    {
     ...
     */
    static auto getDefaultFormatter(): string
    {
     ...
     * are available.
     *
     * @param string myName The name of the formatter to use.
     * @return void
     */
    static auto setDefaultFormatter(string myName): void
    {
        static::translators().defaultFormatter(myName);
    }
     ...
     * @return void
     */
    static function useFallback(bool myEnable = true): void
    {
        static::translators().useFallback(myEnable);
    }
