...
class ComparisonExpression : IExpression, FieldInterface
{
     ...
     */
    this(myField, myValue, Nullable!string myType = null, string $operator = '=') {
        this._type = myType;
     ...
     */
    protected auto _bindValue(myValue, ValueBinder $binder, Nullable!string myType = null): string
    {
     ...
     * @return string
     */
    protected auto _flattenValue(iterable myValue, ValueBinder $binder, Nullable!string myType = null): string
    {
        $parts = [];
        if (is_array(myValue)) {
