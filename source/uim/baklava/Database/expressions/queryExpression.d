...
class QueryExpression : IExpression, Countable
{
     ...
     * @return this
     */
    function eq(myField, myValue, Nullable!string myType = null) {
        if (myType === null) {
     ...
     */
    function case(myValue = null, Nullable!string myType = null): CaseStatementExpression
    {
        if (func_num_args() > 0) {
     ...
     * @return this
     */
    function notInOrNull(myField, myValues, Nullable!string myType = null) {
        $or = new static([], [], 'OR');
        $or
