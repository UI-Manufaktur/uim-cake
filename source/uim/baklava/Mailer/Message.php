...
class Message : JsonSerializable, Serializable
{
     ...
     */
    auto setFrom($email, Nullable!string myName = null) {
     ...
     */
    auto setSender($email, Nullable!string myName = null) {
     ...
     * @throws \InvalidArgumentException
     */
    auto setReplyTo($email, Nullable!string myName = null) {
     ...
     * @return this
     */
    function addReplyTo($email, Nullable!string myName = null) {
     ...
     * @throws \InvalidArgumentException
     */
    auto setReadReceipt($email, Nullable!string myName = null) {
     ...
     * @throws \InvalidArgumentException
     */
    auto setReturnPath($email, Nullable!string myName = null) {
     ...
     * @return this
     */
    auto setTo($email, Nullable!string myName = null) {
     ...
     * @return this
     */
    function addTo($email, Nullable!string myName = null) {
     ...
     * @return this
     */
    auto setCc($email, Nullable!string myName = null) {
     ...
     * @return this
     */
    function addCc($email, Nullable!string myName = null) {
     ...
     * @return this
     */
    auto setBcc($email, Nullable!string myName = null) {
     ...
     * @return this
     */
    function addBcc($email, Nullable!string myName = null) {
     ...
     * @return this
     */
    auto setHeaderCharset(Nullable!string $charset) {
     ...
     * @throws \InvalidArgumentException
     */
    auto setTransferEncoding(Nullable!string $encoding) {
        if ($encoding !== null) {
     ...
     */
    auto getTransferEncoding(): Nullable!string
    {
     ...
     * @return this
     */
    auto setEmailPattern(Nullable!string $regex) {
     ...
     * @return string|null
     */
    auto getEmailPattern(): Nullable!string
    {
     ...
     * @throws \InvalidArgumentException
     */
    protected auto setEmail(string $varName, $email, Nullable!string myName) {
        if (!is_array($email)) {
     ...
     * @throws \InvalidArgumentException
     */
    protected auto setEmailSingle(string $varName, $email, Nullable!string myName, string $throwMessage) {
        if ($email === []) {
            this.{$varName} = $email;
     ...
     * @throws \InvalidArgumentException
     */
    protected auto addEmail(string $varName, $email, Nullable!string myName) {
        if (!is_array($email)) {
            this.validateEmail($email, $varName);
            if (myName === null) {
                myName = $email;
     ...
     */
    protected auto attachFiles(Nullable!string $boundary = null): array
    {
        if ($boundary === null) {
            /** @var string $boundary */
            $boundary = this.boundary;
     ...
     * @return array<string> An array of lines to add to the message
     */
    protected auto attachInlineFiles(Nullable!string $boundary = null): array
    {
        if ($boundary === null) {
            /** @var string $boundary */
            $boundary = this.boundary;
     ...
     * @return this
     */
    auto setPriority(Nullable!int $priority) {
     ...
     */
    protected auto wrap(Nullable!string myMessage = null, int $wrapLength = self::LINE_LENGTH_MUST): array
    {
