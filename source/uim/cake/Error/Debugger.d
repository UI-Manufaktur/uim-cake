...
import uim.cake.errorss\Debug\ArrayItemNode;
import uim.cake.errorss\Debug\ArrayNode;
import uim.cake.errorss\Debug\ClassNode;
import uim.cake.errorss\Debug\ConsoleFormatter;
import uim.cake.errorss\Debug\DebugContext;
import uim.cake.errorss\Debug\IFormatter;
import uim.cake.errorss\Debug\HtmlFormatter;
import uim.cake.errorss\Debug\INode;
import uim.cake.errorss\Debug\PropertyNode;
import uim.cake.errorss\Debug\ReferenceNode;
import uim.cake.errorss\Debug\ScalarNode;
import uim.cake.errorss\Debug\SpecialNode;
import uim.cake.errorss\Debug\TextFormatter;
...
class Debugger
{
     ...
     */
    static function trimPath(string myPath): string
    {
     ...
     * @return string
     */
    protected static auto _highlight(string $str): string
    {
     ...
     */
    static auto getOutputFormat(): string
    {
     ...
     */
    static auto getType($var): string
    {
     ...
     */
    static function formatHtmlMessage(string myMessage): string
    {
