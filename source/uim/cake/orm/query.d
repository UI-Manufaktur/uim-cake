 ...
 * @method uim.cake.Collection\ICollection sortBy($callback, int $dir) Sorts the query with the callback
 ...
 * @method uim.cake.Collection\ICollection extract(myField) Extracts a single column from each row
 ...
 * @method uim.cake.Collection\ICollection groupBy(callable|string myField) In-memory group all results by the value of a column.
 ...
 * @method uim.cake.Collection\ICollection countBy(callable|string myField) Returns the number of unique values for a column
 ...
 * @method uim.cake.Collection\ICollection append(array|\Traversable myItems) Appends more rows to the result of the query.
 ...
 * @method uim.cake.Collection\ICollection zipWith(myCollections, callable $callable) Returns each of the results out of calling $c
