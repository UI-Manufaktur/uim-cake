...
class HasMany : Association
{
    ...
    function saveAssociated(IEntity $entity, array myOptions = []) {
        ...
        if (
            ...
            !_unlinkAssociated($foreignKeyReference, $entity, this.getTarget(), myTargetEntities, myOptions)
        ) {
            return false;
        }
        ...
        if (!_saveTarget($foreignKeyReference, $entity, myTargetEntities, myOptions)) {
            return false;
        }
     ...
     * @param uim.cake.orm.Table myTarget The associated table
    ...
    protected bool _unlinkAssociated(
        ...
        return _unlink(array_keys($foreignKeyReference), myTarget, $conditions, myOptions);
    }
     ...
     *
     * @param uim.cake.orm.Table myTable the table containing the foreign key
