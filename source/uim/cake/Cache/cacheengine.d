...
abstract class CacheEngine : ICache, ICacheEngine
{
     ...
     */
    auto setMultiple(myValues, $ttl = null): bool
    {
     ...
     *   or if any of the myKeys are not a legal value.
     */
    function deleteMultiple(myKeys): bool
    {
        this.ensureValidType(myKeys);
     ...
     */
    abstract auto set(myKey, myValue, $ttl = null): bool;
     ...
     */
    abstract function delete(myKey): bool;
