...
class Cache
{
     ...
     */
    static function write(string myKey, myValue, string myConfig = 'default'): bool
    {
     ...
     */
    static function writeMany(iterable myData, string myConfig = 'default'): bool
    {
     ...
     */
    static function delete(string myKey, string myConfig = 'default'): bool
    {
     ...
     * @throws \Cake\Cache\InvalidArgumentException
     */
    static function deleteMany(iterable myKeys, string myConfig = 'default'): bool
    {
     ...
     */
    static function clear(string myConfig = 'default'): bool
    {
     ...
     */
    static function clearGroup(string $group, string myConfig = 'default'): bool
    {
     ...
     */
    static function add(string myKey, myValue, string myConfig = 'default'): bool
    {
        if (is_resource(myValue)) {
            return false;
        }
