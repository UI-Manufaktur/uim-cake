...
class I18n
{
     ...
     * @return void
     */
    static auto setTranslator(string myName, callable $loader, ?string $locale = null): void
    {
     ...
     */
    static auto getTranslator(string myName = 'default', ?string $locale = null): Translator
    {
        $translators = static::translators();
