...
trait DateFormatTrait
{
     ...
     * @return void
     */
    static auto setDefaultLocale(?string $locale = null): void
    {
     ...
     * @return string
     */
    protected auto _formatObject($date, $format, ?string $locale): string
    {
        $pattern = '';
        ...
        myKey = "{$locale}.{$dateFormat}.{$timeFormat}.{$timezone}.{$calendar}.{$pattern}";

        if (!isset(static::$_formatters[myKey])) {
            ...
            if (empty($formatter)) {
                throw new RuntimeException(
                    ...
                    "`myKey`. You should try to upgrade libicu and the intl extension."
                );
            }
            static::$_formatters[myKey] = $formatter;
        }
     ...
     * @return void
     */
    static auto setToStringFormat($format): void
    {
     ...
     *
     * @return \Cake\Chronos\DifferenceIFormatter
     */
    static auto getDiffFormatter(): DifferenceIFormatter
    {
     ...
     *
     * @param \Cake\Chronos\DifferenceIFormatter $formatter The formatter instance when setting.
     * @return void
     */
    static auto setDiffFormatter(DifferenceIFormatter $formatter): void
    {
