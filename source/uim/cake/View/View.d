...
class View : IEventDispatcher {
    ...
    function element(string myName, array myData = [], array myOptions = []): string
    {
        ...
        throw new MissingElementException([myName . this._ext, $elementName . this._ext], myPaths);
    }
     ...
     */
    function renderLayout(string myContents, ?string $layout = null): string
    {
    ...
    function extend(string myName)
    {
        ...
        switch (myType) {
            ...
            case static::TYPE_LAYOUT:
                $parent = this._getLayoutFileName(myName);
                break;
            default:
     ...
     */
    protected auto _render(string myTemplateFile, array myData = []): string
    {
        if (empty(myData)) {
     ...
     * @return string Rendered output
     */
    protected auto _evaluate(string myTemplateFile, array myDataForView): string
    {
     ...
     */
    protected auto _getTemplateFileName(?string myName = null): string
    {
        ...
        foreach (myPaths as myPath) {
            if (is_file(myPath . myName)) {
                return this._checkFilePath(myPath . myName, myPath);
            }
        }
     ...
     */
    protected auto _inflectTemplateFileName(string myName): string
    {
     ...
     */
    protected auto _getLayoutFileName(?string myName = null): string
    {
        if (myName === null) {
            if (empty(this.layout)) {
                throw new RuntimeException(
     ...
     */
    protected auto _paths(?string myPlugin = null, bool $cached = true): array
    {
        if ($cached === true) {
            ...
            if (myPlugin !== null && isset(this._pathsForPlugin[myPlugin])) {
                return this._pathsForPlugin[myPlugin];
            }
        }
        ...
        if (myPlugin !== null) {
            return this._pathsForPlugin[myPlugin] = myPaths;
        }

        return this._paths = myPaths;
    }
