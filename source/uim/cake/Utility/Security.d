...
class Security
{
     ...
     */
    static function encrypt(string $plain, string myKey, ?string $hmacSalt = null): string
    {
     ...
     * @throws \InvalidArgumentException On invalid data or key.
     */
    static function decrypt(string $cipher, string myKey, ?string $hmacSalt = null): ?string
    {
