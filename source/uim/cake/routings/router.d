...
class Router
{
     ...
     * @return string|null
     */
    static Nullable!string defaultRouteClass(?string $routeClass = null): ?string
    {
        if ($routeClass == null) {
    ...
    static void connect($route, $defaults = [], $options = []) {
        ...
        static::scope("/", void ($routes) use ($route, $defaults, $options) {
     ...
     *   to specify it.
     *
     * @param \Psr\Http\messages.UriInterface|array|string|null $url An array specifying any of the following:
