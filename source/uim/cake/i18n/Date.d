...
import uim.cakeronos\MutableDate;
 ...
 */
class Date : MutableDate : I18nIDateTime
{
    use DateFormatTrait;
     ...
     *
     * The `$timezone` parameter is ignored if `$time` is a IDateTime
     * instance.
     *
    ...
    function timeAgoInWords(array myOptions = []): string
    {
        ...
        return static::getDiffFormatter().dateAgoInWords(this, myOptions);
    }
}
