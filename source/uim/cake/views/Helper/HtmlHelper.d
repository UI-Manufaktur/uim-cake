...
class HtmlHelper : Helper
{
     ...
     */
    function meta(myType, myContents = null, array myOptions = []): ?string
    {
        if (!is_array(myType)) {
            myTypes = [
     ...
     */
    function css(myPath, array myOptions = []): ?string
    {
        myOptions += [
            'once' => true,
            'block' => null,
     ...
     */
    function script(myUrl, array myOptions = []): ?string
    {
        $defaults = [
            'block' => null,
            'once' => true,
     ...
     */
    function scriptBlock(string $script, array myOptions = []): ?string
    {
     ...
     */
    function tag(string myName, ?string $text = null, array myOptions = []): string
    {
     ...
     */
    function div(?string myClass = null, ?string $text = null, array myOptions = []): string
    {
        if (!empty(myClass)) {
     ...
     */
    function para(?string myClass, ?string $text, array myOptions = []): string
    {
