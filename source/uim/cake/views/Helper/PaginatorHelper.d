...
class PaginatorHelper : Helper
{
     ...
     */
    function params(?string myModel = null): array
    {
     ...
     */
    function param(string myKey, ?string myModel = null) {
     ...
     */
    function current(?string myModel = null): int
    {
        myParams = this.params(myModel);
     ...
     */
    function total(?string myModel = null): int
    {
        myParams = this.params(myModel);
     ...
     */
    function sortKey(?string myModel = null, array myOptions = []): ?string
    {
        if (empty(myOptions)) {
     ...
     * @link https://book.cakephp.org/4/en/views/helpers/paginator.html#creating-sort-links
     */
    function sortDir(?string myModel = null, array myOptions = []): string
    {
        $dir = null;
     ...
     */
    function generateUrlParams(array myOptions = [], ?string myModel = null, array myUrl = []): array
    {
     ...
     */
    protected auto _removeAlias(string myField, ?string myModel = null): string
    {
     ...
     * @link https://book.cakephp.org/4/en/views/helpers/paginator.html#checking-the-pagination-state
     */
    function hasPrev(?string myModel = null): bool
    {
     ...
     * @link https://book.cakephp.org/4/en/views/helpers/paginator.html#checking-the-pagination-state
     */
    function hasNext(?string myModel = null): bool
    {
     ...
     * @link https://book.cakephp.org/4/en/views/helpers/paginator.html#checking-the-pagination-state
     */
    function hasPage(int $page = 1, ?string myModel = null): bool
    {
        $paging = this.params(myModel);
        if ($paging === []) {
            return false;
     ...
     */
    protected auto _hasPage(?string myModel, string $dir): bool
    {
        myParams = this.params(myModel);
     ...
     */
    function defaultModel(?string myModel = null): ?string
    {
        if (myModel !== null) {
     ...
     */
    function meta(array myOptions = []): ?string
    {
        myOptions += [
                'model' => null,
                'block' => false,
     ...
     */
    function limitControl(array $limits = [], ?int $default = null, array myOptions = []): string
    {
