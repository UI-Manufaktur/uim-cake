...
class FormHelper : Helper
{
    ...
    function create($context = null, array myOptions = []): string
    {
        ...
        if (myOptions['url'] === false) {
            ...
            myUrl = this._formUrl($context, myOptions);
     ...
     */
    function isFieldError(string myField): bool
    {
     ...
     */
    function label(string myFieldName, ?string $text = null, array myOptions = []): string
    {
        if ($text === null) {
            $text = myFieldName;
    ...
    protected auto _getLabel(string myFieldName, array myOptions) {
        ...
        return this._inputLabel(myFieldName, $label, myOptions);
    }
     ...
     */
    function submit(?string $caption = null, array myOptions = []): string
    {
        if ($caption === null) {
     ...
     */
    protected auto _isDisabled(array myOptions): bool
    {
    ...
    auto getSourceValue(string myFieldname, array myOptions = []) {
        ...
        foreach (this.getValueSources() as myValuesSource) {
            ...
            if (isset(myValueMap[myValuesSource])) {
                ...
                myValue = this._View.getRequest().{$method}(myFieldname);
                if (myValue !== null) {
                    return myValue;
                }
            }
