...
class ConsoleIo
{
     ...
     */
    function out(myMessage = '', int $newlines = 1, int $level = self::NORMAL): ?int
    {
     ...
     */
    function info(myMessage, int $newlines = 1, int $level = self::NORMAL): ?int
    {
        myMessageType = 'info';
     ...
     * @see https://book.cakephp.org/4/en/console-and-shells.html#ConsoleIo::out
     */
    function comment(myMessage, int $newlines = 1, int $level = self::NORMAL): ?int
    {
     ...
     * @see https://book.cakephp.org/4/en/console-and-shells.html#ConsoleIo::out
     */
    function success(myMessage, int $newlines = 1, int $level = self::NORMAL): ?int
    {
