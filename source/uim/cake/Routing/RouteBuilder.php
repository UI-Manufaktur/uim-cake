...
class RouteBuilder
{
     ...
     * @return bool
     */
    function nameExists(string myName): bool
    {
     ...
     * @return string
     */
    function namePrefix(?string myValue = null): string
    {
        if (myValue !== null) {
     ...
     */
    auto get(string myTemplate, myTarget, ?string myName = null): Route
    {
     ...
     * @return \Cake\Routing\Route\Route
     */
    function post(string myTemplate, myTarget, ?string myName = null): Route
    {
     ...
     * @return \Cake\Routing\Route\Route
     */
    function put(string myTemplate, myTarget, ?string myName = null): Route
    {
     ...
     * @return \Cake\Routing\Route\Route
     */
    function patch(string myTemplate, myTarget, ?string myName = null): Route
    {
     ...
     * @return \Cake\Routing\Route\Route
     */
    function delete(string myTemplate, myTarget, ?string myName = null): Route
    {
     ...
     * @return \Cake\Routing\Route\Route
     */
    function head(string myTemplate, myTarget, ?string myName = null): Route
    {
     ...
     * @return \Cake\Routing\Route\Route
     */
    function options(string myTemplate, myTarget, ?string myName = null): Route
    {
     ...
     * @return \Cake\Routing\Route\Route
     */
    protected auto _methodRoute(string $method, string myTemplate, myTarget, ?string myName): Route
    {
        if (myName !== null) {
