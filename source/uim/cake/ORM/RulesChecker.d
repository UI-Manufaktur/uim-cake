...
class RulesChecker : BaseRulesChecker
{
     ...
     * @since 4.0.0
     */
    function isLinkedTo($association, ?string myField = null, ?string myMessage = null): RuleInvoker
    {
     ...
     * @since 4.0.0
     */
    function isNotLinkedTo($association, ?string myField = null, ?string myMessage = null): RuleInvoker
    {
        return this._addLinkConstraintRule(
            $association,
            myField,
